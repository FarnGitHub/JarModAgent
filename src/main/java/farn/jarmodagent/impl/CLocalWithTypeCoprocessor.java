...
public class CLocalWithTypeCoprocessor implements IAnnotationCoprocessor {
    ...
    private LocalVariable[] getLocalVariables(final TransformerManager transformerManager, final ClassNode transformer, final MethodNode transformerMethod, final MethodNode methodNode) {
        ...
        for (CoprocessorUtils.AnnotatedParameter parameter : this.parameters) {
            ...
            CLocalWithType annotation = AnnotationParser.parse(CLocalWithType.class, transformerManager, AnnotationUtils.listToMap(parameter.getAnnotation().values));
            ...
            if (parsedAnnotation.wasSet("loadOpcode")) {
                ...
                variableType = this.getType(annotation.type());
            } else {
    ...
    private static class LocalVariable {
        ...
        private final CLocalWithType annotation;

        private LocalVariable(final int variableIndex, final Type type, final CoprocessorUtils.AnnotatedParameter parameter, final CLocalWithType annotation) {
